...
public class CreateProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("No error".equals(returnedMessage)) {
            ...
            rd = request
                    .getRequestDispatcher("ShowCreateProduct?message=" + AppMessage.INVALID_STOCK_QUANTITY_1.getCode());
        } else if ("Stock quantity cannot be negative".equals(returnedMessage)
                || "Invalid stock quantity format".equals(returnedMessage)) {
            rd = request
                    .getRequestDispatcher("ShowCreateProduct?message=" + AppMessage.INVALID_STOCK_QUANTITY_2.getCode());
            ...
            rd = request.getRequestDispatcher("ShowCreateProduct?message=" + AppMessage.UNKNOWN_ERROR.getCode());
        }
